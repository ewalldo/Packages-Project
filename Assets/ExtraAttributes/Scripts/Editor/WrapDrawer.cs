...
namespace ExtraAttributes
{
    ...
    public class WrapDrawer : PropertyDrawer
	{
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            {
                string errorMessage = "Wrap attribute: Must be used with integer or float property type!";
            ...
            WrapAttribute wrapAttribute = attribute as WrapAttribute;

            float minValue = wrapAttribute.MinValue;
            float maxValue = wrapAttribute.MaxValue;
