...
namespace HealthSystem
{
	public class Health
	{
        ...
        /// <param name="criticalHealthThreshold"></param>
        public Health(float maxHealth, float curHealth, float criticalHealthThreshold = 0f)
        {
            if (criticalHealthThreshold < 0f  || criticalHealthThreshold > 1f)
                throw new ArgumentException("criticalHealthThreshold should be between 0 and 1");
