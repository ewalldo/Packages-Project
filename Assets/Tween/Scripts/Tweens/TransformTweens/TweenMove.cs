...
namespace Tween
{
    public class TweenMove : Vector3Tween
	{
        ...
        public TweenMove(Transform targetObject, Vector3 to, float duration, float delay = 0f, bool isLocalPosition = false, EasingFunction easingFunction = null, ILoopType loopType = null, Action onComplete = null)
            : this(targetObject, targetObject.position, to, duration, delay, isLocalPosition, easingFunction, loopType, onComplete) { }
        ...
        public override IEnumerator Execute()
        {
            ...
            while (progress < 1f)
            {
                ...
                Vector3 newPosition = EasingEquations.Evaluate(easingFunction, progress, initialValue, endValue);
