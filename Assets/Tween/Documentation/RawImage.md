...
- [Documentation](#documentation)
  ...
  - [RawImage Tweens extensions](#rawImageTweensExtensions)
          - [TweenRawImageColor()](#tweenRawImageColorExtensions)
          - [TweenRawImageFade()](#tweenRawImageFadeExtensions)
...
#### 2 RawImage Tweens extensions <a name="rawImageTweensExtensions"/>
Tweens extensions for the RawImage class
##### 2.1 TweenRawImageColor() <a name="tweenRawImageColorExtensions"/>
Apply tween to the color attribute of the RawImage component
#### Declaration
```csharp
...
##### 2.2 TweenRawImageFade() <a name="tweenRawImageFadeExtensions"/>
Apply tween to the alpha attribute of the RawImage component
#### Declaration
```csharp
